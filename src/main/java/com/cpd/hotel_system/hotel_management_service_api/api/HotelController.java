...
public class HotelController{
    ...
    public ResponseEntity<StandardResponseDto> create(@RequestBody RequestHotelDto dto){
        ...
        return new ResponseEntity<>(new StandardResponseDto(201, "Hotel saved", null),
                HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<StandardResponseDto> update(
        ...
        return new ResponseEntity<>(
                new StandardResponseDto(201, "Hotel updated", null),
                HttpStatus.CREATED
        );
    }
    ...
    public ResponseEntity<StandardResponseDto> delete(
        ...
        return new ResponseEntity<>(
                new StandardResponseDto(204, "Hotel deleted", null),
    ...
    public ResponseEntity<StandardResponseDto> findById(
        ...
        return new ResponseEntity<>(
                new StandardResponseDto(200, "hotel found", hotelservice.findById(hotelId)),
                HttpStatus.OK
        );
    }
    ...
    public ResponseEntity<StandardResponseDto> findAll(
        ...
        return new ResponseEntity<>(
                new StandardResponseDto(200, "Hotels list!", hotelservice.findAll(page, size, searchText)), HttpStatus.OK
        );
    }
}
